    ...
    function Project() {
        ...
        return (
            <div style={{marginTop:'6%',paddingTop: '1%', paddingBottom: '2%',textAlign:'center',width:'50%',margin:'auto',fontFamily:'monospace',boxShadow:" 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)"}} className="container">
