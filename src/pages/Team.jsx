        ...
        <div style={{"marginTop": "5%"}}>
            {team && (
                <div className="container" style={{"color": "#fff",paddingBottom: "40px"}}>
                    ...
                    <h1 style={{ textAlign:'center',fontSize: '10px',background: 'linear-gradient(90deg, #6366f1,rgb(153, 77, 235)',WebkitBackgroundClip: 'text',WebkitTextFillColor: 'transparent',display: 'inline-block',}}>Team Management</h1>
