        ...
        <div style={{"marginTop": "5%"}}>
            {team && (
                <div className="container" style={{"color": "#fff",paddingBottom: "40px"}}>
                    ...
                    <h1 style={{ textAlign:'center',fontSize: '40px',background: 'linear-gradient(90deg, #6366f1,rgb(153, 77, 235)',WebkitBackgroundClip: 'text',WebkitTextFillColor: 'transparent',}}>Team Management</h1>
                    <h1 style={{fontSize:'20px'}}>Team Name: {team.team_name}</h1>
